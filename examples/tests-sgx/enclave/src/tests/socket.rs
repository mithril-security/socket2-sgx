...
//#[test]
pub fn domain_fmt_debug() {
    let tests = &[
        (Domain::IPV4, "AF_INET"),
        (Domain::IPV6, "AF_INET6"),
        #[cfg(any(unix, target_env = "sgx"))]
        (Domain::UNIX, "AF_UNIX"),
        #[cfg(all(feature = "all", any(target_os = "fuchsia", target_os = "linux", target_env = "sgx")))]
...
pub fn socket_address_unix_abstract_namespace() {
...
//#[test]
pub fn connect_timeout_unrouteable() {
...
//#[test]
pub fn connect_timeout_unbound() {
...
//#[test]
#[cfg(not(target_os = "redox"))]
pub fn send_from_recv_to_vectored() {
...
//#[test]
#[cfg(not(target_os = "redox"))]
pub fn recv_vectored_truncated() {
    let (socket_a, socket_b) = udp_pair_connected();
...
//#[test]
#[cfg(not(target_os = "redox"))]
pub fn recv_from_vectored_truncated() {
    let (socket_a, socket_b) = udp_pair_unconnected();
    let addr_a = socket_a.local_addr().unwrap();
    let addr_b = socket_b.local_addr().unwrap();
...
pub fn r#type() {
    ...
    #[cfg(all(any(unix, target_env = "sgx"), not(target_vendor = "apple"), feature = "all"))]
    {
...
#[cfg(not(any(target_os = "linux", target_env = "sgx")))]
const GET_BUF_SIZE: usize = SET_BUF_SIZE;
#[cfg(any(target_os = "linux", target_env = "sgx"))]
